...
public class UserDao {
    ...
    public boolean saveUser(User user){
        ...
        try{
            ...
            String query = "insert into user_profile(login,password,first_name,last_name,birth_date,birth_time) values(?,?,?,?,?,?)";
            ...
            pt.setString(6, String.valueOf(user.getBirth_time()));
